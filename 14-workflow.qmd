...
\*\* If you have not moved folders and files around on your computer before, now is the time to learn! On Mac, you can open two Finder windows and navigate to (1) your Downloads folder where you put the `data` folder and (2) the folder that has your R project. You can then drag and drop `data` from (1) into (2): <https://youtu.be/TY_ViHj4gFU?si=ouUEubuP0XbGyTUF&t=136>. On Windows, it is a similar process but you use File Explorer instead of Finder: <https://youtu.be/TiPMMifBR4g?si=nH7WE8s83JyROYlM&t=133>.
...
__Class Exercise 5__. For Mini-Project 2, we will work with some course evaluation data for a professor at SLU. The variables and data set will be described in more detail in the project description.
