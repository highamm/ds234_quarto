...
__Exercise 1__. Take some time to modify your files in this course by creating a `Quizzes` folder. Move the relevant files to these folders and modify each file to load in the `here` package and use the `here()` function to read in any relevant data sets. 
