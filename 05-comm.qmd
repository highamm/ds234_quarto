...
__Your Turn 2__. Go back to the line plot that we made with the fitness data set of `steps` vs. `Start` date. Using `geom_text()`, add a label to the peak at April 14, 2019 that says `"half-marathon"` and a label to the peak at May 24, 2021 that say `"grand canyon"`.
