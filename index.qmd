...
-   you may use the Internet and StackExchange, but you also should not copy paste code directly from the website, without citing that you did so. AI usage for most assignments is not permitted, unless you clearly state __all__ queries that you make and clearly state what you used from the AI responses to the queries.
