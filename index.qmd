...
-   Teaching Assistant: Ryan Tingley [rating24@stlawu.edu](mailto:rating24@stlawu.edu){.email}
...
| 2    | 9/7     | Data Wrangling  with `dplyr`    
   |
| 3    | 9/14    | Communication with `Quarto` and `ggplot2`                   |
| 4    | 9/21    | Soft Skills and Workflow                                    |
| 5    | 9/28  | Data Tidying with `tidyr`                                   |
| 6    | 10/5    | Factors with `forcats`                                                   |
| 7    | 10/12   |    Base `R` and Data Ethics                    |
| 8    | 10/19 | Data Merging with `dplyr`  |
| 9    | 10/26 | Data Import with `readr`, `jsonlite`, `rvest`, and `tibble` |                                    |
| 10   | 11/2 | Intro to Statistical/Machine Learning with knn                              |
| 11   | 11/9    | Text Data with `tidytext` and `stringr`                     |
| 12   | 11/16   |  Dates and Times with `lubridate`  |
| 13   | 11/30   | Connections to STAT and CS                                  |
| 14   | 12/7    | Databases and SQL with `dbplyr`                             |
