...
Throughout this section, we will be using survey data from STAT 113 in the 2018-2019 academic year for many exercises in this section. For those who may not have taken STAT 113 from having AP credit or another reason, the STAT 113 survey is given to all students in STAT 113 across all sections. Some analyses in Intro Stat are then carried out using the survey. 
...
```{r, appendix = TRUE}
library(tidyverse)
fitness_full <- read_csv("data/higham_fitness_clean.csv",
