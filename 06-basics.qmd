...
__Your Turn 6__. Choose one of the games that got labeled and Google that game's median, or possibly average, play time. Is it in the vicinity as the `median_playtime` recorded in our data set? 
...
__Your Turn 7__. What should be done about the outliers? Discuss with your group advantages and disadvantages of keeping the outliers on the plot.
